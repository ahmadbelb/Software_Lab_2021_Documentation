...
%        :P_end: array of points, that has the same length as P. Together with P, this defines all edges of the polygon.
%|Outputs:
%        :lines_on_hull: logical array, which is one, if the corresponding line lies on the convex hull
%        :inner_point: average point of the convex hull,which is guaranteed to lie inside the convex hull
